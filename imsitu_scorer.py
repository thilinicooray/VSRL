...
class imsitu_scorer():
    ...
    def add_point(self, verb_predict, gt_verbs, labels_predict, gt_labels, image_names = None):
        ...
        for i in range(batch_size):
            ...
            sorted_labels = torch.sort(label_pred, 1, True)[1]
            if self.topk == 5:
                print('verb pred' , sorted_idx[0:self.topk], gt_verb, sorted_labels[:,0])
            ...
            for k in range(gt_role_count):
                ...
                for r in range(0,self.nref):
                    ...
                    #print('ground truth label id = ', gt_label_id, label_id)
